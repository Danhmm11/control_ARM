...
# -----data related-----
data_root = 'data_det/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train_data.json'
train_data_prefix = 'annotations/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val_data.json'
val_data_prefix = 'annotations/'  # Prefix of val image path
class_name = ('square', 'octagon', 'hexagon', 'circle')
num_classes = len(class_name) 
# Number of classes for classification
# Batch size of a s80ingle GPU during training
metainfo = dict(classes=class_name, palette= [(0, 0, 0), (0, 0, 255), (0, 255, 0), (255, 0, 0)])
